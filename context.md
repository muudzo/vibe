...
- [x] **Sprint 1**: Foundation - Secure streaming chat + model toggle + simple artifacts.
- [x] **Sprint 2**: Agentic Core - Docker-based Shell & File System integration.
- [/] **Sprint 3**: Visual Automation - Playwright integration & vision-loop.

**Commit Status**: 30/50 granular commits completed.
